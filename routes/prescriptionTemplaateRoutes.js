...
const { getTemplatesByClinicId, add_field_to_template, update_field_in_template, delete_field_from_template, update_logo, sendPDFResponse, getTemplatesByClinicIdAndSection, } = require('../controller/prescriptionTemplateController');
...
router.get('/template/section',isAuth,getTemplatesByClinicIdAndSection)
